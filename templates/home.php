...
function showHome() {
    ...
    foreach ($movies as $movie) {
        $html .= '<li> <a href="viewMovie/' . $movie->id . '">' . $movie->title . '</a> ' . $movie->year . ' ' . '<a href="deleteMovie/' . $movie->id . '">borrar </a>' . '</li>';
    }
...
function addMovieToDB() {
    addMovie($_POST['title'], $_POST['synopsis'], $_POST['year'], $_POST['director']);
